# Announcement draft for owner review

Do not post until the preparation is merged, the repository is public, and the release decisions are complete. The README and Releases links below then need a signed-out check. No hosted beta or public demo URL is announced here.
...
[See Watch It and the setup guide](https://github.com/mgelsinger/watch-it#readme) | [Download a release when published](https://github.com/mgelsinger/watch-it/releases)
